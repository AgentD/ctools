/* threadpool.c -- This file is part of ctools
 *
				    ...
				    void *cleanuparg)
{
	...
	this = calloc(1, sizeof(*this) + sizeof(HANDLE) * (num_workers - 1));
	if (!this)
		return NULL;
			   ...
			   size_t tasksize, tl_allocator *alloc)
{
	...
	task = calloc(1, sizeof(*this) + tasksize);
	if (!task)
		return 0;
...
void tl_threadpool_stats(tl_threadpool *this, size_t *total, size_t *done)
{
	assert(this);
