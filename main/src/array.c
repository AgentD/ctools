...
int tl_array_concat(tl_array * this, const tl_array * src)
{
	...
	tl_allocator_copy(this->alloc,
			  ...
			  (unsigned char *)src->data, src->unitsize, src->used);
...
int tl_array_append(tl_array * this, const void *element)
{
	...
	tl_allocator_copy(this->alloc,
			  (char *)this->data + (this->used -
						1) * this->unitsize, element,
			  this->unitsize, 1);
	return 1;
}
...
int tl_array_prepend(tl_array * this, const void *element)
{
	...
	if (this->used > 1) {
		memmove((unsigned char *)this->data + this->unitsize,
			this->data, (this->used - 1) * this->unitsize);
	}
		    ...
		    const void *element, size_t count)
{
	...
	tl_allocator_copy(this->alloc,
			  (char *)this->data + idx * this->unitsize, element,
			  this->unitsize, count);
...
void tl_array_remove_first(tl_array * this)
{
	...
	if (this->used) {
		tl_allocator_cleanup(this->alloc, this->data, this->unitsize,
				     1);

		if (this->used > 1) {
			memmove(this->data,
				(unsigned char *)this->data + this->unitsize,
